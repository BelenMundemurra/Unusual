        ...
        <>
            <div className='card-detail'>
                ...
                <div>
                    ...
                    <p>{data.descrip}</p>
                    <p className="card-detail-price">Precio: ${data.price}</p>
                    <div className='btn-detail'>
                        {cart.some((el) => el.item.id === data.id) ? 
                            <div>
                                <p className='success-text'>Producto agregado al carrito!</p>
                                <Link to="/cart" className='btn_tran'>IR AL CARRITO</Link>
                            </div> 
                                : 
                            <div>
                                <ItemCount stock={data.stock} setCont={setCont} cont={cont}/>
                                <button onClick={() => onAdd(data,cont)} className='btn_tran'>COMPRAR</button>
                            </div>
                        }
                    </div>
                </div>
